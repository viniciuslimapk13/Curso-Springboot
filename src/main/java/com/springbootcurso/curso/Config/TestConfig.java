...
import com.springbootcurso.curso.Entities.*;
import com.springbootcurso.curso.Entities.Enums.OrderStatus;
import com.springbootcurso.curso.Repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2025-06-20T20:53:07Z"), o1);
        o1.setPayment(pay1);
